...
enum class ErrorType(
    ...
    VERIFICATION_TARGET_INVALID(1400003, HttpStatus.BAD_REQUEST),
    VERIFICATION_CODE_EXPIRED(1400004, HttpStatus.BAD_REQUEST),
    VERIFICATION_CODE_NOT_FOUND(1400005, HttpStatus.BAD_REQUEST),
